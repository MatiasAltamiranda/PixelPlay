    ...
    <>
      <div className="nav">
        <div className="navbar">
          ...
          <div className="icons">
            <i
              className={btn ? "bi bi-list icon show" : "bi bi-list icon icon-list close"}
              onClick={() => {
                setBtn(!btn);
              }}
            ></i>
          ...
          <div className="buttons">
            <button className="menu_btn ingresar show show-buttons">Ingresar</button>
            <button className="menu_btn registro show show-buttons">Registrarse</button>
          </div>
        </div>
