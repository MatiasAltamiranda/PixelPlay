          ...
          "
            >
              <div onClick={toggleDropdown} className="info-user">
                <img
                  className="buttons_profile_photo"
              ...
              {isOpen && (
                <div className="DropDown_User">
                  {logged.role === "admin" ? (
                    <Link className="user_rutas" to="/panel-admin">
                      <i className="bi bi-shield-lock user_rutas me-1"></i>Panel
                      admin
                    </Link>
                  ) : (
                    ""
                  )}
                  <Link className="user_rutas" to="/cart">
                    <i className="bi bi-cart3 user_rutas me-1"></i>Carrito
                  </Link>
                  <Link className="user_rutas" to="/profile">
                    <i className="bi bi-person user_rutas me-1"></i> Perfil
                  </Link>
          ...
          "
            >
              ...
              <div className="DropDown_User_mobile">
                ...
                <Link className="user_rutas" to="/profile">
                  <i className="bi bi-person user_rutas me-1" /> Perfil
                </Link>
                <Logout className="show show-buttons" />
              </div>
            </div>
